...
Command: sbatch run_metagenome_assembly_classification_shortread_en.sh
...
Command: sbatch run_metagenome_assembly_classification_longread_en.sh
...
Run: sbatch run_metagenome_assembly_classification_shortread_en.sh
```
...
Run: sbatch run_metagenome_assembly_classification_longread_en.sh
      Ensure ENABLE_VIRALFLYE="true"
```
