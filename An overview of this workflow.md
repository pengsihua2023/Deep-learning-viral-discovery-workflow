...
│   └── abundance/
│       ├── metaflye/                     # RPM & RPKM metrics
│       └── viralflye/                    # RPM & RPKM metrics
│
...
**Key Deliverables**: 
- `high_confidence_viruses.txt` - Ranked by consensus ⭐⭐⭐
- `abundance/*_abundance.csv` - Viral abundance (RPM & RPKM) ⭐⭐⭐
...
| **Abundance Analysis** | ✅ RPM & RPKM calculation for all identified viruses ⭐⭐⭐ |
